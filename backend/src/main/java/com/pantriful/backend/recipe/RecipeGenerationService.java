...
public class RecipeGenerationService {
    ...
    public GeneratedRecipe generate(List<InventoryItem> pantry) {
        ...
        String system =
                """
                You are a home cooking assistant. Generate exactly one recipe using primarily the \
                ingredients in the user's current pantry, listed below with their exact ids.
